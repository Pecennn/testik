...
set "PHOTOS=a4.png kani.png lenin.png lev.png mge.png noshka.png shrek.png svin.png negritos.png kon.png pchelkon.png iaico.png polynichka.png kon.png pchelkon.png iaico.png polynichka.png"
